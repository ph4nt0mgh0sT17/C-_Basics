...
public:
	...
	/// <param name="number">Number of the account</param>
	/// <param name="client">Client that owns the account</param>
	/// <param name="partner">Partner that owns the client with owner</param>
	Account(int number, Client* client, Client* partner);
	...
	/// <param name="partner">Partner that owns the client with owner</param>
	/// <param name="interestRate">Interest rate of the account</param>
	Account(int number, Client* client, Client* partner, double interstRate);
	...
	/// <summary>
	/// Gets current partner
	/// </summary>
	/// <returns>The partner of the account</returns>
	Client* GetPartner();
