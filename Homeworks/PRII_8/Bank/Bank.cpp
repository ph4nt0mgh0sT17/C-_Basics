...
{
	PartnerAccount* pa = new PartnerAccount(number, owner, partner);
	this->accounts[this->accountsCount] = pa;
	this->accountsCount++;
...
{
	PartnerAccount* pa = new PartnerAccount(number, owner, partner, interestRate);
	this->accounts[this->accountsCount] = pa;
	this->accountsCount++;
